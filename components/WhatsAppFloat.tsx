...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed right-5 bottom-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-petrol text-paper shadow-[0_12px_32px_-8px_rgba(20,60,75,0.55)] transition-transform duration-300 ease-[var(--ease-out-quint)] hover:scale-105 hover:bg-petrol-deep"
    >
